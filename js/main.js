...
const app = (() => {
  ...
  function getImageName(country) {
	    // membuat dan menjalankan promise
  ...
  function isSpain(country) {
	   // Opsional membuat dan menjalankan promise dan jika inputan "Spain"
...
// penggunaan sintak promise
 ...
 // pengguaan semua sintak promise
  const promises = [
    getImageName('Spain'),
    getImageName('Chile'),
    getImageName('Peru')
  ];
// pemanggilan semua fungsi promise
